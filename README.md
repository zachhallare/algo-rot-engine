...
├── used_combos.json                 # Persistent pool tracker — cycles all 10 weapon combos before repeating
...
- Combo tracker (`used_combos.json`) ensures all matchups are cycled before repeating
